...
// drawWinLine() function is called to darw a line on the screen if the condition is met.
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        // If the 3 variables we pass are all included in our array the true is returned and our else if condition executes the drawWinLine() function.
        if (a === true && b === true && c === true) { return true; }
    }
}

// This function make sour body element temporarily unclickable.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    // This functions interacts with the canvas.
